 ...
 * 拷贝于http://www.jianshu.com/p/cd1e80e64311
 * 增加对Snackbar的位置控制,使其可以与底部(类似BottomNavigationView)控件不交叠显示
 * snackbarRefreshLayoutForPaddingBottom()
 */
public class SnackbarUtils {
    ...
    /**
     * 动态改变snackbar的布局.用来解决类tabhost控件与snackbar的显示冲突
     * @param snackbar
     * @param paddingBottom
     */
    public static void snackbarRefreshLayoutForPaddingBottom(Snackbar snackbar,int paddingBottom){
        View snackbarView = snackbar.getView();
        Snackbar.SnackbarLayout snackbarLayout = (Snackbar.SnackbarLayout)snackbarView;
        //先在这里处理一下布局文件的LayoutParams的归属问题
